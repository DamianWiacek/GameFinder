...
namespace GameFinder.Infrastructure.Migrations
{
    ...
    [Migration("20230701120816_PrivateMatch")]
    partial class PrivateMatch
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameFinder.Domain.Entities.Game", b =>
                {
                    ...
                    b.Property<bool>("IsPrivateMatch")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GameFinder.Domain.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("GameFinder.Domain.Entities.UserInbox", b =>
                {
                    b.Property<int>("UserInboxId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserInboxId"), 1L, 1);

                    b.Property<int>("UserId")
                        .HasColumnType("int");

                    b.HasKey("UserInboxId");
            ...
            modelBuilder.Entity("GameFinder.Domain.Entities.Notification", b =>
                {
                    b.HasOne("GameFinder.Domain.Entities.UserInbox", "UserInbox")
            ...
            modelBuilder.Entity("GameFinder.Domain.Entities.UserInbox", b =>
                {
                    b.HasOne("GameFinder.Domain.Entities.User", null)
                        .WithOne("UserInbox")
                        .HasForeignKey("GameFinder.Domain.Entities.UserInbox", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
